					...
					<CardContent className='p-4'>
						<div className='flex flex-wrap items-center justify-between gap-3'>
							<div className='space-y-1'>
								...
								{apt.reason && <p className='text-slate-500 text-sm'>{apt.reason}</p>}
							</div>
							<Badge
								className={
					...
					<CardContent className='p-4'>
						<div className='space-y-2'>
							<div className='flex flex-wrap items-center justify-between gap-2'>
								...
								<Badge variant='outline'>{encounter.type || "Consultation"}</Badge>
							</div>
							{encounter.diagnosis && (
								<p className='text-sm'>
					...
					<CardContent className='p-4'>
						<div className='space-y-2'>
							<div className='flex flex-wrap items-center justify-between gap-2'>
								...
								{record.followUpDate && (
									<Badge variant='outline'>Follow-up: {formatDate(record.followUpDate)}</Badge>
								)}
							</div>
							{record.diagnosis && (
								<p className='text-sm'>
